...
class _Stock_Detail_Report extends State<Stock_Detail_Report> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        ...
        title: Text('Stock Details Report', style: TextStyle(color: Colors.black,fontSize: 18,fontWeight: FontWeight.bold)),
        actions: [
          Container(
            height: 25,
            width: 25,
                          ...
                          return Container(
                            ...
                            child: Column(
                              ...
                              children: [
                                ...
                                Row(
                                  children: [
                                    Text("Closing Quantity : ",style: TextStyle(color: Colors.grey,fontSize: 12),),
                                    Text("50.00",style: TextStyle(fontSize: 13),),
                                  ],
                                ),
                                SizedBox(height: 5,),
                                Row(
  ...
  void showFilter(BuildContext context,int index) {
    ...
    List<String> txnTypes = ["All","Uncategorized","Grocery","Electronic"];
    List<String> parties = ["All","Active","In-Active"];
